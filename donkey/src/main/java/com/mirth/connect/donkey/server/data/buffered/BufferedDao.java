            ...
            while (!tasks.isEmpty()) {
                ...
                switch (task.getTaskType()) {
                    ...
                    case STORE_META_DATA:
                        dao.storeMetaData((ConnectorMessage) p[0], (List<MetaDataColumn>) p[1]);
                        break;
                    ...
                    case DELETE_CONNECTOR_MESSAGES:
                        dao.deleteConnectorMessages((String) p[0], (Long) p[1], (Set<Integer>) p[2]);
                        break;
                    case DELETE_MESSAGE_STATISTICS:
                        dao.deleteMessageStatistics((String) p[0], (Long) p[1], (Set<Integer>) p[2]);
                        break;
                    ...
                    case DELETE_MESSAGE_CONTENT_BY_META_DATA_IDS:
                        dao.deleteMessageContentByMetaDataIds((String) p[0], (Long) p[1], (Set<Integer>) p[2]);
                        break;
