...
public interface AutoResponder {
     ...
     *
     * @param status           - The status the responder should use to determine what
     *                         response to send back.
     * @param message          - The source connector message raw content to base the
     *                         response on.
     * @param connectorMessage - The ConnectorMessage object used to facilitate Velocity
     ...
     * objects.
     *
     * @param message    - The message to base the response generation on.
     * @param properties - A map of additional properties that the AutoResponder needs to generate the
     *                   response string.
     */
