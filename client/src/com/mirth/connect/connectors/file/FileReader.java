...
public class FileReader extends ConnectorSettingsPanel {
     ...
     * @param store     If true, the parsed values are stored to the corresponding form controls.
     * @param highlight If true, fields for which the parsed values are invalid are highlighted.
     */
