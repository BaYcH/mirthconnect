...
public class MessageExportPanel extends JPanel {
     ...
     * @param userPreferences  User preferences to store/retrieve the last browsed directory on the local
     *                         file-system
     * @param archiver         If true, enables the Archive yes/no radio buttons that enable/disable all the
     *                         other components
     * @param allowLocalExport If true, enables components that allow the user to select a local file-system
     *                         folder to export to
     */
