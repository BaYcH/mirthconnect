...
public class Mirth {
    ...
    public static void main(String[] args) {
        ...
        AlertAction alertAction = new AlertAction("abc", "123123");

        String serialize = ObjectXMLSerializer.getInstance().serialize(alertAction);
        AlertAction tempa = ObjectXMLSerializer.getInstance().deserialize(serialize, AlertAction.class);
